        ...
        <div className="mt-10 grid grid-cols-1 gap-8 lg:grid-cols-2">
          ...
          <div className="flex flex-col justify-center gap-5">
            ...
            <div className="flex items-start gap-3">
              ...
              />
              <p className="text-sm text-grey-medium">
                Parking Information — Subject to Confirmation
              </p>
            </div>
            <div className="flex items-start gap-3">
              <Accessibility
              ...
              />
              <p className="text-sm text-grey-medium">
                Accessibility Information — Subject to Confirmation
              </p>
            </div>
            <div className="mt-2 flex flex-wrap gap-4">
              <Button
                ...
                variant="secondary"
              >
                <Navigation className="h-4 w-4" aria-hidden="true" /> Get
                Directions
              </Button>
              <Button href="https://app.warpbay.com/qPMIy6ii" variant="outline">
                Plan Your Visit
              </Button>
            </div>
          </div>
