...
export const metadata: Metadata = {
  title: "Why Visit",
  description:
    "Discover technologies, suppliers and industry opportunities at India Battery International Show 2026. Register as a trade visitor.",
    ...
    <>
            ...
            {whyVisitBenefits.map((benefit) => (
              <div key={benefit.title} className="flex gap-3.5">
                ...
                <div>
                  ...
                  <p className="mt-1.5 text-sm leading-relaxed text-grey-medium">
                    {benefit.description}
                  </p>
                </div>
              </div>
      ...
      <section className="bg-grey-light py-16 sm:py-20">
        <Container>
          <SectionHeading
            ...
            title="What You Will See on the Show Floor"
            align="center"
          />
          <div className="mt-10 grid grid-cols-2 gap-4 sm:grid-cols-4">
            {sectors.map((sector) => (
              <div
                key={sector.slug}
                className="flex flex-col items-center rounded-lg bg-white p-5 text-center shadow-sm"
              >
                <SectorIcon
                  icon={sector.icon}
                  className="mb-2 h-6 w-6 text-red"
                  aria-hidden="true"
                />
      ...
      <section className="py-16 sm:py-20">
        <Container>
          <SectionHeading
            ...
            title="A Focused Industry Audience"
            align="center"
          />
          <div className="mt-10 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
            {visitorProfile.map((item) => (
              <div
                key={item.name}
                className="rounded-xl border border-grey-light p-6"
              >
                <h3 className="font-heading text-sm font-bold text-navy-dark">
                  {item.name}
                </h3>
      ...
      <section className="py-16 sm:py-20">
        <Container className="max-w-3xl">
          <SectionHeading
            eyebrow="Entry Policy"
            title="Who Can Attend"
            align="center"
          />
          <p className="mt-5 text-center text-grey-medium">
            India Battery International Show 2026 is a trade-only event designed
            for industry professionals. Full entry policy and registration terms
            ...
            page and confirmed prior to the show opening.
          </p>
        </Container>
      </section>
      ...
      <section className="bg-grey-light py-16 sm:py-20">
        <Container className="max-w-3xl">
          ...
          <div className="mt-10 flex justify-center gap-4">
            ...
            <Button href="/visit/faqs" variant="ghost">
              All Visitor FAQs
            </Button>
          </div>
        </Container>
