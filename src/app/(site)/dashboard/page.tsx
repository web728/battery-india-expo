      ...
      <DashboardShell roleLabel="Exhibitor" name={name}>
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
          <DashboardCard title="Company Profile">
            <p className="flex items-center gap-2 text-sm text-grey-medium">
              <Building2 className="h-4 w-4" /> {profile.company ?? "Not set"}
            </p>
          </DashboardCard>
          <DashboardCard title="Logo & Product Upload">
            <p className="flex items-center gap-2 text-sm text-grey-medium">
              <Upload className="h-4 w-4" /> No uploads yet
            </p>
          </DashboardCard>
          <DashboardCard title="Stand Information">
            <p className="text-sm text-grey-medium">
              Stand allocation confirmed by the sales team
            </p>
          </DashboardCard>
          <DashboardCard title="Exhibitor Passes">
            <p className="flex items-center gap-2 text-sm text-grey-medium">
              <Ticket className="h-4 w-4" /> Pass allocation confirmed at
              booking
            </p>
          </DashboardCard>
          <DashboardCard title="Support">
            <p className="flex items-center gap-2 text-sm text-grey-medium">
              <LifeBuoy className="h-4 w-4" /> Contact our sales team for
              assistance
            </p>
          </DashboardCard>
        </div>
    ...
    <DashboardShell roleLabel="Visitor" name={name}>
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
        <DashboardCard title="Registration Pass">
          <p className="flex items-center gap-2 text-sm text-grey-medium">
            <QrCode className="h-4 w-4" /> View your pass on the confirmation
            page
          </p>
        </DashboardCard>
        <DashboardCard title="Saved Exhibitors">
          <p className="flex items-center gap-2 text-sm text-grey-medium">
            <Users className="h-4 w-4" /> No exhibitors saved yet
          </p>
        </DashboardCard>
        <DashboardCard title="Profile">
          <p className="flex items-center gap-2 text-sm text-grey-medium">
            <UserCircle className="h-4 w-4" />{" "}
            {profile.company ?? "Update your profile"}
          </p>
        </DashboardCard>
        <DashboardCard title="Downloads">
          <p className="flex items-center gap-2 text-sm text-grey-medium">
            <FileDown className="h-4 w-4" /> Event brochure available
          </p>
        </DashboardCard>
      </div>
    </DashboardShell>
